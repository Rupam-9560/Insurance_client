...
export default function ApprovedPolicy() {
  ...
  useEffect(() => {
    fetch(
      ...
      .catch(() => {
        alert("Failed to fetch approved policies");
        setLoading(false);
      });
  }, []);
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-8 space-y-6">
        ...
        <AdminHeader title="Approved Policies" />

        <div className="bg-white p-8 rounded-2xl shadow-lg overflow-x-auto">

          {loading ? (
            <p className="text-gray-500">Loading approved policies...</p>
          ) : data.length === 0 ? (
